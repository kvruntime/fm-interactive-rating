...
})({"hvIYv":[function(require,module,exports) {
"use strict";
...
var _ratingViewJs = require("./RatingView.js");
var _ratingViewJsDefault = parcelHelpers.interopDefault(_ratingViewJs);
"use strict";
console.log("connected...");
const app = document.querySelector("#app");
const view = new (0, _ratingViewJsDefault.default)(app);

},{"./RatingView.js":"fm75d","@parcel/transformer-js/src/esmodule-helpers.js":"gcZYk"}],"fm75d":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
    ...
    <form method="POST" id="rating-form">
      ...
      `;
        ...
        this.root.querySelector("#rating-form").addEventListener("submit", (e)=>{
            ...
            if (rating) return this._updateInterface(this._createThankElement(rating));
            alert("please rate score...");
        });
        // Handle choosing a rated
        const ratingButtons = this.root.querySelectorAll(".rating__action");
        ratingButtons.forEach((element)=>element.addEventListener("pointerdown", (e)=>{
                // Remove active status
                ratingButtons.forEach((button)=>button.classList.remove("rating__action--active"));
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gcZYk"}],"gcZYk":[function(require,module,exports) {
...
},{}]},["hvIYv","k84bg"], "k84bg", "parcelRequire94c2")
